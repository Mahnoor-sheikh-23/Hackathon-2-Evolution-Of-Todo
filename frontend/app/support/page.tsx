    ...
    return (
      <div className={`min-h-screen ${theme === 'dark' ? 'bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900' : 'bg-gradient-to-br from-gray-100 via-purple-50 to-white'} relative overflow-hidden flex items-center justify-center`}>
        ...
        <div className="text-center animate-fade-in-up z-10">
          ...
          <p className={`mt-4 text-lg ${theme === 'dark' ? 'text-white/70' : 'text-gray-600'}`}>Loading support page...</p>
      ...
      <div className="py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            <div className={`${theme === 'dark' ? 'bg-slate-800/50' : 'bg-white/50'} backdrop-blur-xl rounded-2xl p-8 border ${theme === 'dark' ? 'border-white/10' : 'border-gray-200/50'} hover:border-white/20 transition-all duration-300`}>
              <div className="text-4xl mb-4">📚</div>
              <h3 className={`text-xl font-semibold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-4`}>Documentation</h3>
              <p className={`${theme === 'dark' ? 'text-white/70' : 'text-gray-600'} mb-6`}>Comprehensive guides and tutorials to help you get the most out of TaskFlow.</p>
              <Link
                href="#"
                className={`${theme === 'dark' ? 'text-indigo-400 hover:text-indigo-300' : 'text-indigo-600 hover:text-indigo-500'} font-medium transition-colors`}
              >
                View Documentation →
              </Link>
            </div>
            ...
            <div className={`${theme === 'dark' ? 'bg-slate-800/50' : 'bg-white/50'} backdrop-blur-xl rounded-2xl p-8 border ${theme === 'dark' ? 'border-white/10' : 'border-gray-200/50'} hover:border-white/20 transition-all duration-300`}>
              <div className="text-4xl mb-4">💬</div>
              <h3 className={`text-xl font-semibold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-4`}>Live Chat</h3>
              <p className={`${theme === 'dark' ? 'text-white/70' : 'text-gray-600'} mb-6`}>Get instant help from our support team during business hours.</p>
              <Link
                href="#"
                className={`${theme === 'dark' ? 'text-indigo-400 hover:text-indigo-300' : 'text-indigo-600 hover:text-indigo-500'} font-medium transition-colors`}
              >
            ...
            <div className={`${theme === 'dark' ? 'bg-slate-800/50' : 'bg-white/50'} backdrop-blur-xl rounded-2xl p-8 border ${theme === 'dark' ? 'border-white/10' : 'border-gray-200/50'} hover:border-white/20 transition-all duration-300`}>
              <div className="text-4xl mb-4">📧</div>
              <h3 className={`text-xl font-semibold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-4`}>Email Support</h3>
              <p className={`${theme === 'dark' ? 'text-white/70' : 'text-gray-600'} mb-6`}>Send us a message and we'll get back to you within 24 hours.</p>
              <Link
                href="#"
                className={`${theme === 'dark' ? 'text-indigo-400 hover:text-indigo-300' : 'text-indigo-600 hover:text-indigo-500'} font-medium transition-colors`}
              >
          ...
          {/* FAQ Section */}
          <div className={`${theme === 'dark' ? 'bg-slate-800/50' : 'bg-white/50'} backdrop-blur-xl rounded-3xl p-8 border ${theme === 'dark' ? 'border-white/10' : 'border-gray-200/50'} mb-16`}>
            <h2 className={`text-3xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-8 text-center`}>Frequently Asked Questions</h2>
            <div className="space-y-6">
              {[
                ...
                },
                {
                  ...
                  answer: "Yes, you can upgrade your account at any time from the billing section in your profile. Your new features will be available immediately."
                },
                {
                  question: "How secure is my data?",
                  answer: "We take security seriously. All data is encrypted both in transit and at rest. We follow industry best practices for data protection and privacy."
                },
                {
                ...
                },
                {
                  ...
                  answer: "Yes, we offer team plans with features like shared workspaces, team collaboration tools, and centralized billing management."
                }
              ].map((faq, index) => (
                <div key={index} className={`${theme === 'dark' ? 'border-b border-white/10' : 'border-b border-gray-200/50'} pb-6 last:border-b-0`}>
                  <h3 className={`text-lg font-semibold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-2`}>{faq.question}</h3>
                  <p className={`${theme === 'dark' ? 'text-white/70' : 'text-gray-600'}`}>{faq.answer}</p>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className={`${theme === 'dark' ? 'bg-slate-800/50' : 'bg-white/50'} backdrop-blur-xl rounded-3xl p-8 border ${theme === 'dark' ? 'border-white/10' : 'border-gray-200/50'}`}>
            <h2 className={`text-3xl font-bold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-8 text-center`}>Need More Help?</h2>
            <form className="space-y-6">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  <label className={`block text-sm font-medium ${theme === 'dark' ? 'text-white/70' : 'text-gray-700'} mb-2`}>Name</label>
                  <input
                    type="text"
                    className={`w-full px-4 py-3 border ${theme === 'dark' ? 'border-white/20 rounded-xl bg-slate-700/50 text-white placeholder-white/50' : 'border-gray-300 rounded-xl bg-white text-gray-900 placeholder-gray-500'} focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-all duration-300`}
                    placeholder="Your name"
                  />
                </div>
                <div>
                  <label className={`block text-sm font-medium ${theme === 'dark' ? 'text-white/70' : 'text-gray-700'} mb-2`}>Email</label>
                  <input
                    type="email"
                    className={`w-full px-4 py-3 border ${theme === 'dark' ? 'border-white/20 rounded-xl bg-slate-700/50 text-white placeholder-white/50' : 'border-gray-300 rounded-xl bg-white text-gray-900 placeholder-gray-500'} focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-all duration-300`}
              ...
              <div>
                <label className={`block text-sm font-medium ${theme === 'dark' ? 'text-white/70' : 'text-gray-700'} mb-2`}>Subject</label>
                <input
                  type="text"
                  className={`w-full px-4 py-3 border ${theme === 'dark' ? 'border-white/20 rounded-xl bg-slate-700/50 text-white placeholder-white/50' : 'border-gray-300 rounded-xl bg-white text-gray-900 placeholder-gray-500'} focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-all duration-300`}
              ...
              <div>
                <label className={`block text-sm font-medium ${theme === 'dark' ? 'text-white/70' : 'text-gray-700'} mb-2`}>Message</label>
                <textarea
                  rows={6}
                  className={`w-full px-4 py-3 border ${theme === 'dark' ? 'border-white/20 rounded-xl bg-slate-700/50 text-white placeholder-white/50' : 'border-gray-300 rounded-xl bg-white text-gray-900 placeholder-gray-500'} focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-all duration-300`}
