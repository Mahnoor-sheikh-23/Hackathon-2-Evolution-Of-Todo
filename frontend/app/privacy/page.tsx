    ...
    return (
      <div className={`min-h-screen ${theme === 'dark' ? 'bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900' : 'bg-gradient-to-br from-gray-100 via-purple-50 to-white'} relative overflow-hidden flex items-center justify-center`}>
        ...
        <div className="text-center animate-fade-in-up z-10">
          ...
          <p className={`mt-4 text-lg ${theme === 'dark' ? 'text-white/70' : 'text-gray-600'}`}>Loading privacy page...</p>
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className={`${theme === 'dark' ? 'bg-slate-800/50' : 'bg-white/50'} backdrop-blur-xl rounded-3xl p-8 border ${theme === 'dark' ? 'border-white/10' : 'border-gray-200/50'}`}>
            <div className={`prose ${theme === 'dark' ? 'prose-invert' : ''} max-w-none`}>
              ...
              <h3 className={`text-xl font-semibold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-4`}>Information We Collect</h3>
              ...
              <ul className={`list-disc list-inside ${theme === 'dark' ? 'text-white/70' : 'text-gray-600'} mb-6 space-y-2`}>
                <li>Your name, email address, and other profile information</li>
                <li>Task and project data you create using our service</li>
              ...
              <h3 className={`text-xl font-semibold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-4`}>How We Use Your Information</h3>
              <p className={`${theme === 'dark' ? 'text-white/70' : 'text-gray-600'} mb-6`}>
              ...
              <h3 className={`text-xl font-semibold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-4`}>Data Security</h3>
              <p className={`${theme === 'dark' ? 'text-white/70' : 'text-gray-600'} mb-6`}>
                We implement appropriate technical and organizational measures to protect your personal information against unauthorized access, alteration, disclosure, or destruction. All data is encrypted both in transit and at rest.
              </p>

              <h3 className={`text-xl font-semibold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-4`}>Data Sharing</h3>
              <p className={`${theme === 'dark' ? 'text-white/70' : 'text-gray-600'} mb-6`}>
              ...
              <h3 className={`text-xl font-semibold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-4`}>Your Rights</h3>
              <p className={`${theme === 'dark' ? 'text-white/70' : 'text-gray-600'} mb-6`}>
              ...
              <h3 className={`text-xl font-semibold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-4`}>Cookies and Tracking</h3>
              <p className={`${theme === 'dark' ? 'text-white/70' : 'text-gray-600'} mb-6`}>
                We use cookies and similar tracking technologies to improve your experience with our services. You can control cookie settings through your browser preferences.
              </p>

              <h3 className={`text-xl font-semibold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-4`}>Data Retention</h3>
              <p className={`${theme === 'dark' ? 'text-white/70' : 'text-gray-600'} mb-6`}>
                We retain your personal information for as long as necessary to provide our services and comply with legal obligations. When data is no longer needed, we securely delete it.
              </p>

              <h3 className={`text-xl font-semibold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-4`}>Contact Us</h3>
              <p className={`${theme === 'dark' ? 'text-white/70' : 'text-gray-600'} mb-6`}>
                If you have questions about this privacy policy or concerns about our data practices, please contact us at:
              </p>
              <p className={`${theme === 'dark' ? 'text-white/70' : 'text-gray-600'} mb-6`}>
              ...
              <h3 className={`text-xl font-semibold ${theme === 'dark' ? 'text-white' : 'text-gray-900'} mb-4`}>Changes to This Policy</h3>
