...
{{- printf "%s-frontend" (include "todo-app.name" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- printf "%s-backend" (include "todo-app.name" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
...
Database name
*/}}
{{- define "todo-app.database.name" -}}
{{- printf "%s-db" (include "todo-app.name" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
...
{{- printf "%s-db" (include "todo-app.fullname" .) | trunc 63 | trimSuffix "-" }}
{{- end }}
...
app.kubernetes.io/name: {{ include "todo-app.database.name" . }}
app.kubernetes.io/instance: {{ .Release.Name }}
{{- end }}
